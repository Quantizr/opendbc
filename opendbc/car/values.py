...
from opendbc.car.odyssey.values import CAR as ODYSSEY
...
Platform = BODY | CHRYSLER | FORD | GM | HONDA | HYUNDAI | MAZDA | MOCK | MG | NISSAN | ODYSSEY | PSA | RIVIAN | SUBARU | TESLA | TOYOTA | VOLKSWAGEN
