...
class CAR(Platforms):
  HONDA_ODYSSEY_2005 = HondaOdysseyStepperServoConfig(
    ...
    CarSpecs(mass=1700, wheelbase=3.0, steerRatio=24, centerToFrontRatio=0.45, tireStiffnessFactor=1.0), # steerRatio doesn't match actual car, not sure why
