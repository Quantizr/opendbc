...
class CAR(Platforms):
  HONDA_ODYSSEY_2005 = HondaOdysseyStepperServoConfig(
    ...
    CarSpecs(mass=1700, wheelbase=3.0, steerRatio=20, centerToFrontRatio=0.45, tireStiffnessFactor=1.0), # TODO: steerRatio doesn't match actual car, check SSC config
