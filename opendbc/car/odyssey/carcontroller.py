...
from opendbc.car import Bus, DT_CTRL, rate_limit, make_tester_present_msg, structs, apply_dist_to_meas_limits
from opendbc.car.odyssey import hondacan
from opendbc.car.odyssey.values import CruiseButtons, CarControllerParams
...
class CarController(CarControllerBase, MadsCarController):
  ...
  def update(self, CC, CC_SP, CS, now_nanos):
    ...
    if CC.latActive:
      ...
      apply_steer = 0
      can_sends.append(hondacan.create_steer_command(self.frame, hondacan.SteeringModes.Off))
